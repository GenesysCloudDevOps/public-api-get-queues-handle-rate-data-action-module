A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Queues Handle Rate
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-queues-handle-rate-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Queues Handle Rate"
